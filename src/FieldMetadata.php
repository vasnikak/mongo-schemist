...
class FieldMetadata {
	...
	/**
	 * Evaluates a value and adds its information info the field's metadata.
	 *
	 * @param mixed $val
	...
	/**
	 * Helper method used that toArray method uses.
	 *
	...
	/**
	 * Checks if the object is equal with another one.
	 *
